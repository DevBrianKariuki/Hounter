    ...
    <div className='w-full py-6 sm:px-20 px-6 flex flex-col md:flex-row'>
        <div className='flex w-full justify-center  md:w-[50%] flex-col gap-2'>
            <div className='flex flex-col py-3  gap-2'>
                ...
                <p className='font-lexend font-bold text-primary text-3xl'>Let’s tour and see our house!</p>
            </div>
            <p className='font-lexend text-sm max-w-[70%] text-fadeblue'>Houses recommended by our partners that have been curated to become the home of your dreams!</p>
            ...
            <div className='flex w-full pt-5 md:max-w-[70%] justify-between'>
                <div className='flex gap-3  items-center'>
                    ...
                    <div className='flex flex-col'>
                        <p className='font-lexend font-medium text-primary'>Dianne Russell</p>
                        <p className='text-xs text-fadeblue font-lexend'>Managing Director</p>
                    </div>
                </div>
